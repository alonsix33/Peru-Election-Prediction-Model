      ...
      {predictions?.is_frozen && (
        <div style={{
          ...
          <div style={{ color: '#92400E', fontWeight: 700, fontSize: 16, marginBottom: 6 }}>
            FOTO FINAL DEL MODELO — 7 de junio de 2026, 5:00pm Lima
          </div>
          <div style={{ color: '#A16207', fontSize: 13, lineHeight: 1.5 }}>
            El modelo segunda vuelta se ha detenido. Esta predicción será usada para el análisis post-mortem contra los resultados oficiales de la ONPE.
          </div>
