    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 40 }}>
      ...
      <div style={{ background: '#FFFFFF', border: '1px solid #E5E0D8', borderRadius: 12, padding: '24px 28px' }}>
        ...
        <StepRow number={5} title="El alpha — cuánto peso le damos a Polymarket"
          description="El alpha (α) controla qué tanto influye Polymarket vs las encuestas. Hoy está en 22%: Polymarket pesa 22%, encuestas 78%. El 31 de mayo empezó la veda electoral — las encuestas se congelaron pero Polymarket sigue moviéndose. El alpha sube gradualmente hasta 50% el día de la elección. Cap conservador: PM tiene sesgo estructural hacia el candidato más conocido en mercados de baja liquidez. Gracias a la corrección del paso anterior, esto ya no distorsiona el resultado: Polymarket ahora dice '~52% de votos para Keiko', que es casi lo mismo que las encuestas. Subir el alpha de 22% a 50% mueve el posterior menos de 1pp." />
